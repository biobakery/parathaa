...
max(get_all_distances_to_root(as.phylo(tre)))



test <- read.tree("~/Repos/Parathaa2_OP3/BB3/region_specific.tree")
test$tip.label <- gsub("\\..*", "", test$tip.label)
test$tip.label

write.tree(test, file="~/Desktop/test.tree")
table(test$tip.label)
